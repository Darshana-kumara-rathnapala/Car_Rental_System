...
function setCarDataToFields(car) {
    ...
    let frontViewImg = frontViewPath.split("J:\\Web design\\Car Rental Project\\Front_End\\savedImages\\Cars\\")[1];
    let FrontViewImgSrc = "savedImages\\Cars\\" + frontViewImg;

    let backViewPath = car.backViewImg;
    let backViewImg = backViewPath.split("J:\\Web design\\Car Rental Project\\Front_End\\savedImages\\Cars\\")[1];
    let backViewImgSrc = "savedImages\\Cars\\" + backViewImg;
    console.log(backViewImgSrc);

    let sideViewPath = car.sideViewImg;
    let sideViewImg = sideViewPath.split("J:\\Web design\\Car Rental Project\\Front_End\\savedImages\\Cars\\")[1];
    let sideViewImgSrc = "savedImages\\Cars\\" + sideViewImg;

    let interiorViewPath = car.internalViewImg;
    let interiorViewImg = interiorViewPath.split("J:\\Web design\\Car Rental Project\\Front_End\\savedImages\\Cars\\")[1];
